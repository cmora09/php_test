    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            @if (Auth::user()->admin())
                <h1> Hello Admin </h1>
                <a href="{{ url('/admin')}}">
                     <h4> Check pending rebates </h4>
                </a>
            @else
                <h2 class="text-center">Submit a new rebate</h2>
                {{Form::open(array('action' => 'RebateController@store', 'class' => 'form-horizontal','files'=>true))}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="g-recaptcha" data-sitekey="6LfG2wsUAAAAALzwC2MimY4D-DoGxvVL6lx1B3Yl"></div>
                {{Form::close()}}
                <br>
                @endif
